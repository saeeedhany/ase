...
const char kAboutHtmlTemplate[] =
    "<p><b>Absolute Simple Editor</b><br>"
    "Version %1 &mdash; in development, not yet publicly released</p>"
    "<p>A minimal, robust, blazingly fast, and aesthetically deliberate "
    "GUI text editor.</p>"
    "<p>Developed by <b>Saeed</b><br>"
    "<a href=\"%2\" style=\"color:%4;\">%2</a><br>"
    "<a href=\"%3\" style=\"color:%4;\">%3</a></p>"
    "<p>All phases of the \"complete normal editor\" pass are done — "
    "undo/redo, selection, clipboard, find/replace, editor chrome, and "
    "a command line with :compile. Full modal Vim emulation is planned "
    "next. The license is still an open decision, so this isn't "
    "published publicly yet.</p>";
}
